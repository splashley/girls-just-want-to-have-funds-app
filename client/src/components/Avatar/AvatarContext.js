...
const AvatarProvider = () => {
  //Features useState
  const [topType, setTopType] = React.useState("LongHairMiaWallace");
  const [accessoriesType, setAccessoriesType] = React.useState(
    "Prescription02"
  );
  const [hairColor, setHairColor] = React.useState("BrownDark");
  const [clotheType, setClotheType] = React.useState("Hoodie");
  const [clotheColor, setClotheColor] = React.useState("PastelBlue");
  const [eyeType, setEyeType] = React.useState("Happy");
  const [eyebrowType, setEyebrowType] = React.useState("Default");
  const [mouthType, setMouthType] = React.useState("Smile");
  const [skinColor, setSkinColor] = React.useState("Light");
